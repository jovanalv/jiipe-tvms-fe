      ...
      <View style={cardStyles.infoContainer}>
        ...
        <View style={isSingle ? cardStyles.singleInfoRow : cardStyles.infoRow}>
          ...
          <Text
            style={isSingle ? cardStyles.singleInfoValue : cardStyles.infoValue}
          >
            {contractor.contractorEmail || "No Email Provided"}
          </Text>
        </View>
        <View style={isSingle ? cardStyles.singleInfoRow : cardStyles.infoRow}>
          <Text
          ...
          <Text
            style={isSingle ? cardStyles.singleInfoValue : cardStyles.infoValue}
          >
            {contractor.contractorPhone || "No Phone Number Provided"}
          </Text>
        </View>
      </View>
    </View>
...
export const AllContractorsPDF = ({ contractors, qrImages }) => {
  const pages = [];
        ...
        <Page key={pageIndex} size="A4" style={cardStyles.page}>
          {pageContractors?.map((contractor, index) => (
            <ContractorCardPDF
              ...
              qrImage={qrImages?.[contractor.regid]}
              isSingle={false}
            />
          ))}
          <Text
...
export const SingleContractorPDF = ({ contractor, qrImage }) => (
  <Document>
