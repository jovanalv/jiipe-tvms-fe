      ...
      <View style={cardStyles.infoContainer}>
        ...
        <View style={isSingle ? cardStyles.singleInfoRow : cardStyles.infoRow}>
          ...
          <Text
            style={isSingle ? cardStyles.singleInfoValue : cardStyles.infoValue}
          >
            {visitor?.no_hp || "No Phone Number Provided"}
          </Text>
        </View>
      </View>
    </View>
...
export const AllVisitorsMasterPDF = ({ visitors, qrImages }) => {
  const pages = [];
...
export const SingleVisitorMasterPDF = ({ visitor, qrImage }) => (
  <Document>
...
export default {
  AllVisitorsMasterPDF,
  SingleVisitorMasterPDF,
};
